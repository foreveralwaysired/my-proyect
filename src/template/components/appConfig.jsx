...
const AppConfig = (props) => {
    const menuThemes = [
        { name: 'white', color: '#ffffff', logoColor: 'dark', componentTheme: props.componentTheme },
        { name: 'darkgray', color: '#343a40', logoColor: 'white', componentTheme: props.componentTheme },
